...
#                           get_cell_type_proportions, add_pheno_column!
...
# datasets_desc = MTR.Preprocessing.read_datasets(esets_description_file)
...
#     else
#         @error "The files for dataset $(dataset.id) have not been downloaded. Please download them first."
#     end
# end
